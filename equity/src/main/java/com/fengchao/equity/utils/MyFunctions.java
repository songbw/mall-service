...
public class MyFunctions {
    ...
    public static final String WEB_ADMIN_CREATE_COUPON="controller:管理端创建createCoupon优惠券 ";
    public static final String WEB_ADMIN_UPDATE_COUPON="controller:管理端修改updateCoupon优惠券 ";
    ...
    public static final String WEB_REDEMPTION_COUPON="controller:客户端兑换redemption优惠券 ";
