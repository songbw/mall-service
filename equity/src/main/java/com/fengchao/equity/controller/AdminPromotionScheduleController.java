...
//    }
    ...
    public OperaResult createInitialSchedule(@RequestBody PromotionInitialScheduleBean bean, OperaResult result){
        result.getData().put("result", scheduleService.createInitialSchedule(bean));
        return result;
    }
