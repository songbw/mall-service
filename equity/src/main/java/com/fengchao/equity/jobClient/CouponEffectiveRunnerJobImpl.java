...
public class CouponEffectiveRunnerJobImpl implements JobRunner {

    private static final Logger LOGGER = LoggerFactory.getLogger(CouponEffectiveRunnerJobImpl.class);
    ...
    public Result run(JobContext jobContext) throws Throwable {
        try {
            ...
            // TODO 业务逻辑
            LOGGER.info("我要执行优惠券生效操作：" + jobContext);
