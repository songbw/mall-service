...
public class ImsMcMembers {
    ...
    public String getXyCreateTime() {
        return xyCreateTime;
    }

    public void setXyCreateTime(String xyCreateTime) {
        this.xyCreateTime = xyCreateTime == null ? null : xyCreateTime.trim();
    }
    ...
    public Integer getHavehb() {
        return havehb;
    }

    public void setHavehb(Integer havehb) {
        this.havehb = havehb;
    }
}