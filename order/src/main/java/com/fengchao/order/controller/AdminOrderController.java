...
//        titleCell29.setCellValue("快捷支付退款 单位:元"); // 主订单
        ...
        titleCell23.setCellValue("奥弋订单号");

        HSSFCell titleCell24 = titleRow.createCell(24);
        titleCell24.setCellValue("收件人名");

        HSSFCell titleCell25 = titleRow.createCell(25);
        titleCell25.setCellValue("省");

        HSSFCell titleCell26 = titleRow.createCell(26);
        titleCell26.setCellValue("市");

        HSSFCell titleCell27 = titleRow.createCell(27);
        titleCell27.setCellValue("区");

        HSSFCell titleCell28 = titleRow.createCell(28);
        titleCell28.setCellValue("详细地址");

        HSSFCell titleCell29 = titleRow.createCell(29);
        titleCell29.setCellValue("收件人手机号");
    }
    /**
     * 组装业务数据
     *
...
//                        sheet.addMergedRegion(new CellRangeAddress(startLineNum, endLineNum, 9, 9));
                ...
                cell6.setCellValue(exportOrdersVo.getOpenId());

                // 子订单编号，
                HSSFCell cell7 = currentRow.createCell(7);
                cell7.setCellValue(exportOrdersVo.getSubOrderId());

                // 子订单状态
                HSSFCell cell8 = currentRow.createCell(8);
                cell8.setCellValue(exportOrdersVo.getOrderDetailStatus());

                // 订单支付时间，
                HSSFCell cell9 = currentRow.createCell(9);
                cell9.setCellValue("");
                if (exportOrdersVo.getPaymentTime() != null) {
                    cell9.setCellValue(DateUtil.dateTimeFormat(exportOrdersVo.getPaymentTime(), DateUtil.DATE_YYYY_MM_DD_HH_MM_SS));
                }
                ...
                if (exportOrdersVo.getCreateTime() != null) {
                    cell10.setCellValue(DateUtil.dateTimeFormat(exportOrdersVo.getCreateTime(), DateUtil.DATE_YYYY_MM_DD_HH_MM_SS));
                }

                // 品类，
                HSSFCell cell11 = currentRow.createCell(11);
                cell11.setCellValue(exportOrdersVo.getCategory());

                // 品牌（通过mpu获取）
                HSSFCell cell12 = currentRow.createCell(12);
                cell12.setCellValue(exportOrdersVo.getBrand());

                // 供应商
                HSSFCell cell13 = currentRow.createCell(13);
                cell13.setCellValue(exportOrdersVo.getMerchantName());

                // sku，
                HSSFCell cell14 = currentRow.createCell(14);
                cell14.setCellValue(exportOrdersVo.getSku());

                // mpu，
                HSSFCell cell15 = currentRow.createCell(15);
                cell15.setCellValue(exportOrdersVo.getMpu());

                // 商品名称，
                HSSFCell cell16 = currentRow.createCell(16);
                cell16.setCellValue(exportOrdersVo.getCommodityName());

                // 购买数量 ，
                HSSFCell cell17 = currentRow.createCell(17);
                cell17.setCellValue(exportOrdersVo.getQuantity());

                // 活动 ，
                HSSFCell cell18 = currentRow.createCell(18);
                cell18.setCellValue(exportOrdersVo.getSettlementType());
...
//                cell29.setCellValue(exportOrdersVo.getQuickPayRefund());
                ...
                cell23.setCellValue(exportOrdersVo.getAoyiID());

                // 收件人名
                HSSFCell cell24 = currentRow.createCell(24);
                cell24.setCellValue(exportOrdersVo.getBuyerName());

                // 省
                HSSFCell cell25 = currentRow.createCell(25);
                cell25.setCellValue(exportOrdersVo.getProvinceName());

                // 市
                HSSFCell cell26 = currentRow.createCell(26);
                cell26.setCellValue(exportOrdersVo.getCityName());

                // 区
                HSSFCell cell27 = currentRow.createCell(27);
                cell27.setCellValue(exportOrdersVo.getCountyName());

                // 详细地址
                HSSFCell cell28 = currentRow.createCell(28);
                cell28.setCellValue(exportOrdersVo.getAddress());
