...
import com.fengchao.commission.task.AlarmTask;
import com.fengchao.commission.threadpool.ThreadPoolManager;
...
public class AlarmUtil {
    ...
    private static ExecutorService alarmExecutor = ThreadPoolManager
            .createThreadPoolExecutor("alarmTaskPool", 20, 50, 300);
