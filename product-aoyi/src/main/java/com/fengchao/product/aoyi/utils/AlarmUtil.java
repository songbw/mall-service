...
import com.fengchao.product.aoyi.task.AlarmTask;
import com.fengchao.product.aoyi.threadpool.ThreadPoolManager;
...
public class AlarmUtil {
    ...
    private static ExecutorService alarmExecutor =
            ThreadPoolManager.createThreadPoolExecutor("productAlarmTaskPool", 20, 50, 300);
